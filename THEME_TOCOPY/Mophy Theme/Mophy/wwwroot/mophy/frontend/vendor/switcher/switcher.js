...
themeOption['themeFullColor'] = ['mophy/frontend/css/skin/skin-1', 'mophy/frontend/css/skin/skin-2', 'mophy/frontend/css/skin/skin-3', 'mophy/frontend/css/skin/skin-4', 'mophy/frontend/css/skin/skin-5', 'mophy/frontend/css/skin/skin-6', 'mophy/frontend/css/skin/skin-7', 'mophy/frontend/css/skin/skin-8', 'mophy/frontend/css/skin/skin-9','mophy/frontend/css/skin/skin-10','themeFullColor_value','themeFullColor_logo'];
...
jQuery(window).on('load', function(){
	...
	jQuery(document).on('click', '.theme-color', function(){
		jQuery(".skin").attr("href", 'mophy/frontend/css/skin/'+jQuery(this).data('color-theme')+'.css');
	...
	/*  if(
		currentURL.indexOf('@Url.Action("Index","Admin")') > -1
	...
	)
	{
		...
		if( currentURL.indexOf('@Url.Action("Index","Admin")') > -1 || currentURL.indexOf('.html') == -1){
			var pageSkin = 'skin-1';
	...
	jQuery.each(themeOption, function(index, themeOptionItem) {
		...
		if(themeOptionItemValue != '' && themeOptionItemValue != '1'){
			...
			if(themeOptionItem == 'themeStandardColor'){
				...
				jQuery(".skin").attr("href", 'mophy/frontend/css/skin/'+themeOptionItemValue+'.css');
