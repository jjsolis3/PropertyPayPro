...
namespace PropertyPayPro.Migrations
{
    ...
    [Migration("20260720000000_AddInspections")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PropertyPayPro.Models.Inspection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PairedMoveInId");

                    b.ToTable("Inspections");
                });

            modelBuilder.Entity("PropertyPayPro.Models.InspectionItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PropertyPayPro.Models.InspectionPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PropertyPayPro.Models.MaintenanceSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("LastServiceTicketId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PropertyPayPro.Models.Inspection", b =>
                {
                    ...
                    b.HasOne("PropertyPayPro.Models.Inspection", "PairedMoveIn")
                        .WithMany()
                        .HasForeignKey("PairedMoveInId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("Lease");

                    b.Navigation("PairedMoveIn");
                });

            modelBuilder.Entity("PropertyPayPro.Models.InspectionItem", b =>
                {
                    b.HasOne("PropertyPayPro.Models.Inspection", "Inspection")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("PropertyPayPro.Models.InspectionPhoto", b =>
                {
                    b.HasOne("PropertyPayPro.Models.InspectionItem", "InspectionItem")
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("PropertyPayPro.Models.RentPayment", b =>
                {
                    ...
                    b.HasOne("PropertyPayPro.Models.Tenant", "PaidByTenant")
                        .WithMany()
