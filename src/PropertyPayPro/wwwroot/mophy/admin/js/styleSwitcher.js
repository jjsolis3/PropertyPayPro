    ...
    //change the theme direction (rtl, ltr) controller
     themeDirectionSelect.on('change', function() {
        ...
        if(html.attr('dir') === "rtl"){
            jQuery('.main-css').attr('href','../mophy/admin/css/style-rtl.css');
		}else{
			console.log('000000');
            jQuery('.main-css').attr('href','../mophy/admin/css/style.css')
		}
